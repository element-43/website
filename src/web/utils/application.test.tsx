...
describe('utilities/application', () => {
    describe('getHelmet()', () => {
        ...
        it('should use the default values if nothing is specified', () => {
            ...
            expect(_.find(props.meta, ['name', 'description']).content).toBe(document.description);

            expect(_.find(props.meta, ['name', 'twitter:description']).content).toBe(document.description);
            expect(_.find(props.meta, ['name', 'twitter:title']).content).toBe(document.title);

            expect(_.find(props.meta, ['name', 'og:description']).content).toBe(document.description);
            expect(_.find(props.meta, ['name', 'og:title']).content).toBe(document.title);
